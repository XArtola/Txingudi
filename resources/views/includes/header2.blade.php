...
<div class="navbar">
    ...
    <a href="{{url('#newContact')}}" class="green"><img src="{{asset('assets/images/icons/contact.png')}}"><span class="trn responsiveText" data-trn-key="menuContact">Contacto</span></a>
    <ul class="languages">
